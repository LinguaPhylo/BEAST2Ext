...
public interface KeyParameter<T> extends Parameter<T> {
    ...
    abstract class KeyBase<T> extends StateNode implements KeyParameter<T> {
        ...
        @Override
        public KeyBase<T> copy() {
            try {
                @SuppressWarnings("unchecked") final KeyParameter.KeyBase<T> copy = (KeyParameter.KeyBase<T>) this.clone();
        ...
        public void assignTo(final StateNode other) {
            @SuppressWarnings("unchecked") final KeyParameter.KeyBase<T> copy = (KeyParameter.KeyBase<T>) other;
            copy.setID(getID());
            copy.index = index;
        ...
        public void assignFrom(final StateNode other) {
            @SuppressWarnings("unchecked") final KeyParameter.KeyBase<T> source = (KeyParameter.KeyBase<T>) other;
            setID(source.getID());
